...
async function POST(req) {
    try {
        ...
        // Create user and initial default USD account
        const newUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].user.create({
            data: {
                name: fullName,
                email: email,
                ...
                accounts: {
                    create: {
                        accountNumber: "CB-" + Math.floor(1000000000 + Math.random() * 9000000000),
                        balance: 1000.00,
                        currency: "USD"
                    }
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__12jmd_r._.js.map