...
async function GET() {
    ...
    if (!session || session.user?.role !== "ADMIN") return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Forbidden"
    }, {
        status: 403
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        settings: await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].adminSetting.findMany({
            orderBy: {
                key: "asc"
            }
        })
...
async function PUT(request) {
    ...
    for (const [key, value] of Object.entries(values))await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].adminSetting.upsert({
        where: {
            key
        },
        update: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0s8uapn._.js.map