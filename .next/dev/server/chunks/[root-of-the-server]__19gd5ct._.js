...
async function proxy(req) {
    ...
    if (path === "/admin/login") {
        if (token?.role === "ADMIN") return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/admin", req.url));
        if (token) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/dashboard", req.url));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__19gd5ct._.js.map