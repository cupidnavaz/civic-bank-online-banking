...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$account$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/account.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET() {
    ...
    try {
        ...
        const accounts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].account.findMany({
            where: {
                userId: user.id
            },
            orderBy: {
...
async function POST(req) {
    ...
    try {
        ...
        if (!supportedCurrencies.includes(currency) || ![
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Choose a supported currency and account type."
            }, {
                status: 400
            });
        }
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].account.findFirst({
            where: {
                userId: user.id,
                currency,
                type: accountType
        ...
        if (existing) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: `You already have a ${currency} ${accountType.toLowerCase()} account.`
        }, {
            status: 409
        });
        const account = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].account.create({
            data: {
                userId: user.id,
                accountNumber: `CB-${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$account$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateAccountNumber"])()}`,
                currency,
                type: accountType,
                balance: 0,
                status: "ACTIVE"
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].notification.create({
            data: {
                ...
                message: `Your ${currency} ${accountType.toLowerCase()} account is ready.`
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            account
...
"[project]/lib/account.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function generateAccountNumber() {
    return `${Date.now().toString().slice(-8)}${Math.floor(1000 + Math.random() * 9000)}`;
}
function reference(prefix = "TXN") {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1v9e5ax._.js.map