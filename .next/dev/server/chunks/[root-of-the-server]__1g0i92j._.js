...
"[project]/app/api/crypto/purchase/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    try {
        ...
        if (!price || !Number.isFinite(purchaseAmount) || purchaseAmount <= 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Choose a supported asset and valid purchase amount."
        }, {
            status: 400
        });
        ...
        const account = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].account.findFirst({
            where: {
                id: accountId,
                userId: user.id,
                currency: "USD",
        ...
        if (!account) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Select an active USD funding account."
        }, {
            status: 400
        });
        if (Number(account.balance) < purchaseAmount) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].$transaction(async (tx)=>{
            ...
            const holding = await tx.cryptoHolding.findFirst({
                where: {
                    userId: user.id,
            ...
            const updatedHolding = holding ? await tx.cryptoHolding.update({
                where: {
                    id: holding.id
                },
                data: {
            ...
            await tx.transaction.create({
                data: {
                    ...
                    status: "COMPLETED",
                    reference,
                    description: `Demo purchase of ${quantity.toFixed(8)} ${asset}`
                }
            });
            ...
            await tx.notification.create({
                data: {
                    ...
                    message: `You purchased ${quantity.toFixed(8)} ${asset} for USD ${purchaseAmount.toLocaleString()}.`
                }
            });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Unable to complete crypto purchase."
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1g0i92j._.js.map