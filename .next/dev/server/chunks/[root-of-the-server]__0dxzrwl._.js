...
async function POST(req) {
    ...
    try {
        ...
        while(await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].virtualCard.findUnique({
            where: {
                cardNumber
            },
            select: {
        ...
        }))cardNumber = `4${digits(15)}`;
        const now = new Date();
        const expiryDate = `${String(now.getMonth() + 1).padStart(2, "0")}/${String(now.getFullYear() + 4).slice(-2)}`;
        const card = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].virtualCard.create({
            data: {
                userId: user.id,
                cardNumber,
                cardHolder: holder,
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].notification.create({
            data: {
                ...
                message: `A new virtual card ending in ${cardNumber.slice(-4)} is active.`
            }
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Unable to issue virtual card."
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0dxzrwl._.js.map